...
public static class DataAccessServiceCollectionExtensions
{
        ...
        this IServiceCollection services, DatabaseProvider provider, string connectionString)
    {
        ...
        services.AddScoped<IRamsAcknowledgementRepository, RamsAcknowledgementRepository>();
        services.AddScoped<IDocumentDistributionRepository, DocumentDistributionRepository>();
        ...
        services.AddScoped<IHavsExposureRepository, HavsExposureRepository>();
        ...
        services.AddScoped<ISubcontractorOnboardingConfigRepository, SubcontractorOnboardingConfigRepository>();
        services.AddScoped<IOperativeDeviceRepository, OperativeDeviceRepository>();
