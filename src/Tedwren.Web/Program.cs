...
// Config-driven site chrome (Web Plan §3): header, footer and CTAs read identity/nav from the "Site"
// section so copy changes need no redeploy. This is the seam W2 swaps for an IContentProvider.
