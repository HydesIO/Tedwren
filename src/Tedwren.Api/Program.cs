...
builder.Services.AddSubcontractorOnboardingCore();
...
if (backend.Mode == DataSourceMode.InMemory)
{
    ...
    builder.Services.AddInMemoryMasterDataStore();
    ...
    builder.Services.AddInMemorySubcontractorOnboardingStore();
...
app.MapManagerSiteEntryEndpoints();
...
app.MapEvidenceCaptureEndpoints();
app.MapOnboardingEndpoints();
app.MapTradeOnboardingEndpoints();
app.MapSubcontractorOnboardingEndpoints();
