...
public static class LaunchAnnouncementEmail
{
    ...
    /// </summary>
    public static string BuildContent(string startUrl)
    {
        return new EmailContentBuilder()
            ...
            .Callout("You're receiving this because you asked to be told when Tedwren launched. If that wasn't you, simply ignore this email.")
